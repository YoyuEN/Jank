<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-row>
        <el-col :span="6">
          <el-form-item label="评论所属用户ID" prop="userId" label-width="150px">
            <el-input
              v-model="queryParams.userId"
              placeholder="请输入评论所属用户ID"
              clearable
        ...
        <el-col :span="6">
          <el-form-item label="评论所属文章ID" prop="postId" label-width="150px">
            <el-input
              v-model="queryParams.postId"
              placeholder="请输入评论所属文章ID"
              clearable
              @keyup.enter.native="handleQuery"
            />
          </el-form-item>
